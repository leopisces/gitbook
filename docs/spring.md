...
* 从使用和占有率看
  ...
  * 所以说,Spring技术是JavaEE开发必备技能，企业开发技术选型命中率>**90%**
    ...
    ![](/pics/spring/image-20210729171139088.png)
...
* Spring发展到今天已经形成了一种开发的生态圈,Spring提供了若干个项目,每个项目用于完成特定的功能。
  ...
  * Spring有若干个项目，可以根据需要自行选择，把这些个项目组合起来，起了一个名称叫**全家桶**，如下图所示
    ...
    ![](/pics/spring/image-20210729171850181.png)

    **说明:**

    图中的图标都代表什么含义，可以进入spring官方网站进行对比查看。

    这些技术并不是所有的都需要学习，额外需要重点关注`Spring Framework`、`SpringBoot`和`SpringCloud`:

    ![](/pics/spring/1629714811435.png)
...
![](/pics/spring/image-20210729171926576.png)
...
* Spring Framework的发展也经历了很多版本的变更，每个版本都有相应的调整
  ...
  ![](/pics/spring/image-20210729172153796.png)

* Spring Framework的5版本目前没有最新的架构图，而最新的是4版本，所以接下来主要研究的是4的架构图

  ![](/pics/spring/1629720945720.png)
...
![](/pics/spring/image-20210729184337603.png)
...
![](/pics/spring/image-20210729183500978.png)
...
![](/pics/spring/image-20210729183558051.png)
...
* bean依赖注入的ref属性指定bean，必须在容器中存在
  ...
  ![](/pics/spring/1629771744003.png)

* 如果不存在,则会报错，如下:

  ![](/pics/spring/1629771880920.png)

  这个错误大家需要特别关注下:

  ![](/pics/spring/1629771972886.png)
...
![](/pics/spring/image-20210729183628138.png)
...
![](/pics/spring/image-20210729195248948.png)
...
* 调用对象中的方法来创建bean，对应的是第二行配置
  ...
  * factory-method:工厂对象中的具体创建对象的方法名,对应关系如下:
    ...
    ![](/pics/spring/image-20210729200203249.png)
...
![1629792339889](/pics/spring/1629792339889.png)
...
* 运行程序，就能执行destroy方法的内容
  ...
  ![1629792857608](/pics/spring/1629792857608.png)
...
![1629794527419](/pics/spring/1629794527419.png)
...
* 思考:afterPropertiesSet和setBookDao谁先执行?
  ...
  * 重新运行AppForLifeCycle，打印结果如下:
    ...
    ![1629794928636](/pics/spring/1629794928636.png)
...
![1629799214191](/pics/spring/1629799214191.png)
...
![1629799873386](/pics/spring/1629799873386.png)
...
![1629800324721](/pics/spring/1629800324721.png)
...
![1629800748639](/pics/spring/1629800748639.png)
...
![1629802656916](/pics/spring/1629802656916.png)
...
![1629802697318](/pics/spring/1629802697318.png)
...
![1629803111769](/pics/spring/1629803111769.png)

上面已经完成了构造函数注入的基本使用，但是会存在一些问题:

![1629803529598](/pics/spring/1629803529598.png)
...
![1629805387647](/pics/spring/1629805387647.png)
...
* 按照名称注入中的名称指的是什么?
  ...
  ![1629806856156](/pics/spring/1629806856156.png)
...
![1629807579330](/pics/spring/1629807579330.png)
...
![1629808046783](/pics/spring/1629808046783.png)
...
* 创建一个Maven项目
  ...
  ![1629860338328](/pics/spring/1629860338328.png)
...
![1629887733081](/pics/spring/1629887733081.png)
...
* 从mvn的仓库`https://mvnrepository.com/`中进行搜索
  ...
  ![1629888540286](/pics/spring/1629888540286.png)
...
![1629889170229](/pics/spring/1629889170229.png)
...
![1629903845404](/pics/spring/1629903845404.png)
...
![1629975492444](/pics/spring/1629975492444.png)
...
* 问题一:键值对的key为`username`引发的问题
  ...
  ![1629975934694](/pics/spring/1629975934694.png)
...
### 6.2.3 加载properties文件小结

  本节主要讲解的是properties配置文件的加载，需要掌握的内容有:

  * 如何开启`context`命名空间

    ![1629980280952](/pics/spring/1629980280952.png)
...
![1629982672522](/pics/spring/1629982672522.png)
...
![1629983245121](/pics/spring/1629983245121.png)
...
![1629985148294](/pics/spring/1629985148294.png)

(2)点击进入BeanFactory类，ctrl+h,就能查看到如下结构的层次关系

![1629984980781](/pics/spring/1629984980781.png)
...
![1629986510487](/pics/spring/1629986510487.png)
...
![1629986848563](/pics/spring/1629986848563.png)
...
![1629989221808](/pics/spring/1629989221808.png)
...
![1629990315619](/pics/spring/1629990315619.png)
...
![1630027590558](/pics/spring/1630027590558.png)
...
![1630027743910](/pics/spring/1630027743910.png)
...
![1630028345074](/pics/spring/1630028345074.png)
...
![1630029110506](/pics/spring/1630029110506.png)

至此，纯注解开发的方式就已经完成了，主要内容包括:

* Java类替换Spring核心配置文件

  ![1630029254372](/pics/spring/1630029254372.png)
...
![1630031112993](/pics/spring/1630031112993.png)

### 8.4.2 Bean的作用范围

(1)先运行App类,在控制台打印两个一摸一样的地址，说明默认情况下bean是单例

![1630031192753](/pics/spring/1630031192753.png)
...
![1630031808947](/pics/spring/1630031808947.png)
...
![1630032385498](/pics/spring/1630032385498.png)
...
![1630033039358](/pics/spring/1630033039358.png)
...
![1630033604129](/pics/spring/1630033604129.png)

环境准备好后，运行后会发现有问题

![1630033710052](/pics/spring/1630033710052.png)
...
![1630034272959](/pics/spring/1630034272959.png)
...
* 先给两个Dao类分别起个名称
  ...
  * 分析下面这种情况是否能完成注入呢?
    ...
    ![1630036236150](/pics/spring/1630036236150.png)
...
![1630084683663](/pics/spring/1630084683663.png)
...
![1630122466404](/pics/spring/1630122466404.png)
...
![1630125475609](/pics/spring/1630125475609.png)
...
![1630134786448](/pics/spring/1630134786448.png)
...
![1630136904087](/pics/spring/1630136904087.png)
...
* Mybatis程序核心对象分析
  ...
  ![1630137189480](/pics/spring/1630137189480.png)

  从图中可以获取到，真正需要交给Spring管理的是**SqlSessionFactory**

* 整合Mybatis，就是将Mybatis用到的内容交给Spring管理，分析下配置文件

  ![1630137388717](/pics/spring/1630137388717.png)
...
* 使用SqlSessionFactoryBean封装SqlSessionFactory需要的环境信息
  ...
  ![1630138835057](/pics/spring/1630138835057.png)
...
* 使用MapperScannerConfigurer加载Dao接口，创建代理对象保存到IOC容器中
  ...
  ![1630138916939](/pics/spring/1630138916939.png)
...
![1630139036627](/pics/spring/1630139036627.png)
...
![1630139720273](/pics/spring/1630139720273.png)
